      ...
      @forelse ($operators as $operatore)
        ...
        <tr class="text-gray-700 dark:text-gray-400">
          <td class="px-4 py-3">
              ...
              <div>
                <p class="font-semibold"> {{ $operatore['name']}}</p>
          ...
          <td>
           ...
           <a class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded inline-flex items-center" href="{{route('operatores.edit',['operatore'=>$operatore['id']])}}">Update</a>
